...
@pytest.fixture
def cozy_auth_token() -> str:
    """Retrieve auth token generated by cozy-stack."""
    with open("cozy-config/cozy-auth-token", "r") as f:
        return f.read().strip()


@pytest.fixture
def cozy_auth_data(cozy_auth_token: str) -> CozyAuthData:
    """Decode and validate auth token generated by cozy-stack."""
...
@pytest.fixture
def cozy_auth_target(cozy_auth_data: CozyAuthData) -> dict:
    return cozy_auth_data.model_dump_json()
