...
def test_cli_read_command_usage():
    ...
    assert (
        ...
        "Options:\n"
        "  -b, --backend "
        "[async_es|async_lrs|async_mongo|async_ws|clickhouse|cozystack|es|fs|ldp|lrs|mongo|s3|"
        "swift]\n"
        "                                  Backend  [required]\n"
        "  async_es backend: \n"
...
def test_cli_list_command_usage():
    ...
    assert (
        ...
        "Options:\n"
        "  -b, --backend [async_es|async_mongo|clickhouse|cozystack|es|fs|ldp|mongo|s3|swift]\n"  # noqa: E501
        "                                  Backend  [required]\n"
        "  async_es backend: \n"
        "    --async-es-allow-yellow-status / --no-async-es-allow-yellow-status\n"
        "    --async-es-client-options KEY=VALUE,KEY=VALUE\n"
...
def test_cli_write_command_usage():
    ...
    expected_output = (
        ...
        "Options:\n"
        "  -b, --backend "
        "[async_es|async_lrs|async_mongo|clickhouse|cozystack|es|fs|lrs|mongo|s3|swift]"
        "\n"
        "                                  Backend  [required]\n"
        "  async_es backend: \n"
        "    --async-es-allow-yellow-status / --no-async-es-allow-yellow-status\n"
...
def test_cli_runserver_command_usage():
    ...
    expected_output = (
        ...
        "Options:\n"
        "  -b, --backend [async_es|async_mongo|clickhouse|cozystack|es|fs|mongo]\n"
        "                                  Backend  [required]\n"
        "  async_es backend: \n"
        "    --async-es-allow-yellow-status / --no-async-es-allow-yellow-status\n"
        "    --async-es-client-options KEY=VALUE,KEY=VALUE\n"
